...
import type { Driver } from '../global';
...
export default function DriverCard({ driver, onBook }: DriverCardProps) {
  return (
    <div key={driver.id} className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105">
