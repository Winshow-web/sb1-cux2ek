...
import {Lock, Mail, Truck, Users, X, User} from 'lucide-react';
import {AccountType, User as user} from "@global/types";
...
export default function AuthModal({ onClose, baseUrl, setUser, setShowAuthModal, redirect }: AuthModalProps) {
